    ...
    return (
        ...
        >
            <div className="bg-black bg-opacity-80 p-10 w-full max-w-md text-center rounded-xl shadow-lg">
                ...
                <h2 className="text-2xl font-semibold text-white mb-1">Daftar</h2>
                <p className="text-gray-300 mb-6">Selamat Datang!</p>
                ...
                {isMobile && (
                    <p className="text-white mt-5 text-xs">Tampilan mobile terdeteksi</p>
                )}
            </div>
        </div>
    );
